    ...
    protected void onStart() {
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                bb = Integer.valueOf(dataSnapshot.child("PILLS").child(user.getUid()).child("PILL2").child("period").child("B-B").getValue().toString());
                bl = Integer.valueOf(dataSnapshot.child("PILLS").child(user.getUid()).child("PILL2").child("period").child("B-L").getValue().toString());
                bd = Integer.valueOf(dataSnapshot.child("PILLS").child(user.getUid()).child("PILL2").child("period").child("B-D").getValue().toString());
                ab = Integer.valueOf(dataSnapshot.child("PILLS").child(user.getUid()).child("PILL2").child("period").child("A-B").getValue().toString());
                al = Integer.valueOf(dataSnapshot.child("PILLS").child(user.getUid()).child("PILL2").child("period").child("A-L").getValue().toString());
                ad = Integer.valueOf(dataSnapshot.child("PILLS").child(user.getUid()).child("PILL2").child("period").child("A-D").getValue().toString());
