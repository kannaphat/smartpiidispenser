    ...
    protected void onStart() {
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                bb = Integer.valueOf(dataSnapshot.child("PILLS").child(user.getUid()).child("PILL1").child("period").child("BB").getValue().toString());
                bl = Integer.valueOf(dataSnapshot.child("PILLS").child(user.getUid()).child("PILL1").child("period").child("BL").getValue().toString());
                bd = Integer.valueOf(dataSnapshot.child("PILLS").child(user.getUid()).child("PILL1").child("period").child("BD").getValue().toString());
                ab = Integer.valueOf(dataSnapshot.child("PILLS").child(user.getUid()).child("PILL1").child("period").child("AB").getValue().toString());
                al = Integer.valueOf(dataSnapshot.child("PILLS").child(user.getUid()).child("PILL1").child("period").child("AL").getValue().toString());
                ad = Integer.valueOf(dataSnapshot.child("PILLS").child(user.getUid()).child("PILL1").child("period").child("AD").getValue().toString());
